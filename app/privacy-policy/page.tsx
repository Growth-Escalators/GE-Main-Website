    ...
    <>
      ...
      <main className="min-h-screen bg-[var(--bg-primary)] pt-32 pb-24 px-6 md:px-16 lg:px-32">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-extrabold text-4xl md:text-5xl text-[var(--text-primary)] mb-6 leading-tight">Privacy Policy</h1>
          <p className="text-[var(--text-muted)] font-light mb-16 text-base">We are committed to protecting your privacy.</p>
          <div className="space-y-12 font-light text-[var(--text-muted)] leading-relaxed text-base">
            <section>
              <h2 className="font-extrabold font-bold text-xl text-[var(--text-primary)] mb-3">Information Collected</h2>
            ...
            <section>
              <h2 className="font-extrabold font-bold text-xl text-[var(--text-primary)] mb-3">Information Use</h2>
            ...
            <section>
              <h2 className="font-extrabold font-bold text-xl text-[var(--text-primary)] mb-3">Cookies</h2>
            ...
            <section>
              <h2 className="font-extrabold font-bold text-xl text-[var(--text-primary)] mb-3">Disclosing Information</h2>
              <p>We do not share your personal information with third parties unless you give us permission. We may use your information to contact you and share updates related to Growth Escalators. You can opt out of our communications at any time.</p>
            </section>
            <section>
              <h2 className="font-extrabold font-bold text-xl text-[var(--text-primary)] mb-3">Changes to this Policy</h2>
