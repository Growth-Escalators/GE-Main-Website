...
export const JEWELLERY_JAIPUR_CONTENT: LandingContent = {
  ...
  faqs: [
    ...
    { q: 'What does digital marketing for a jewelry brand in Jaipur actually include?', a: 'Six connected pieces: an Instagram/Reels content system built for trust and craftsmanship storytelling, D2C and website performance marketing (Meta/Google) for online sales, Google Business Profile and local SEO so you rank for "jewellery showroom Jaipur," wedding-season and festive campaigns, a WhatsApp/CRM nurture funnel for the weeks-long consideration cycle, and a properly catalogued website. We run all six as one system, not separate add-ons.' },
    { q: 'How does jewelry ecommerce SEO work for a Jaipur brand selling online?', a: 'It starts with a properly categorised, high-resolution online catalog — filterable by metal, budget, and occasion — because Google, and buyers, can\'t rank or shortlist what isn\'t structured. From there it\'s technical and on-page SEO layered with content targeting high-intent searches, plus the trust signals — certification, hallmarking messaging, reviews — a high-ticket purchase needs before a search visitor converts.' },
    { q: 'What does SEO for a physical jewelry store in Jaipur look like, versus an online-only jewelry seller?', a: 'For a showroom, SEO is mostly local: a fully optimised Google Business Profile (photos, categories, Q&A, review velocity), consistent NAP across directories, and content targeting locality-specific searches — Johari Bazar, MI Road, C-Scheme, Vaishali Nagar — plus "jewellers near me" intent. That\'s different from ecommerce SEO, which is about catalog and product-page structure; most Jaipur jewellery brands need both, in different proportions depending on how much revenue comes from the showroom versus online.' },
    { q: 'What does a jewellery marketing agency actually do?', a: 'It runs the specific mix a high-ticket, trust-dependent purchase needs: content and social proof that builds confidence before a sale, performance ads that connect to a WhatsApp inquiry or showroom visit rather than just chasing clicks, local SEO so intent-driven searches find you, and campaign timing built around festive and wedding-season demand. Growth Escalators does this from Jaipur — India\'s jewellery capital — with ₹10Cr+ in ad spend managed and 97% client retention across the brands we work with.' },
  ],
