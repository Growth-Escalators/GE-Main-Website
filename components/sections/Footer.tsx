...
const FOOTER_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Women's Clothing Growth", href: '/d2c/fashion/womens-clothing' },
      { label: 'Real Estate Project Launch', href: '/real-estate/project-launch-marketing' },
      { label: 'Travel Marketing India', href: '/travel-marketing-agency' },
      { label: 'White-Label SEO', href: '/white-label-seo-agency' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'IVF Clinics', href: '/ivf-marketing-agency-jaipur' },
      { label: 'Orthopaedic Doctors', href: '/orthopedic-marketing-agency-jaipur' },
      ...
      { label: 'Restaurants & F&B', href: '/restaurant-marketing-agency-jaipur' },
