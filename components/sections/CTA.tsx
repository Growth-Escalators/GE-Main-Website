  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute w-[500px] h-[500px] opacity-10" style={{ background: '#FF6B35', top: '-15%', left: '15%', filter: 'blur(100px)', animation: 'blob1 8s ease-in-out infinite', borderRadius: '60% 40% 30% 70% / 60% 30% 70% 40%' }} />
      ...
      <div className="cta-content relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center gap-6">
        <span className="text-[10px] tracking-[0.4em] uppercase" style={{ color: 'var(--orange)' }}>
          Let&apos;s Work Together
        </span>

        <h2 className="font-extrabold leading-none" style={{ fontSize: 'clamp(40px, 8vw, 96px)', color: 'var(--text-primary)', lineHeight: 1.0 }}>
          Ready To Stop<br />
          <span style={{ color: 'var(--orange)' }}>Playing Small?</span>
        </h2>

        <p className="font-light text-lg max-w-xl" style={{ color: 'var(--text-muted)', lineHeight: 1.75 }}>
        ...
        <div className="relative mt-2">
          ...
          <MagneticButton
            as="a"
            href="/contact"
            className="relative font-semibold px-10 py-5 text-base z-10 transition-colors duration-300"
        ...
        <p className="font-light text-sm" style={{ color: 'var(--text-muted)', opacity: 0.6 }}>
